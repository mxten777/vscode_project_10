...
const ADMIN_ACTIONS = {
  ...
  "backfill-awards-1m": { path: "/api/jobs/backfill-awards?months=1&startMonthsAgo=0", method: "POST" },
  "backfill-awards-2m": { path: "/api/jobs/backfill-awards?months=1&startMonthsAgo=1", method: "POST" },
  "backfill-awards-3m": { path: "/api/jobs/backfill-awards?months=1&startMonthsAgo=2", method: "POST" },
