...
import { ArrowRight, Building, CreditCard, LayoutGrid, ShieldCheck, Sparkles, User } from "lucide-react";
...
export default function SettingsLayout({ children }: { children: React.ReactNode }) {
  ...
  const activeItem = sidebarItems.find((item) => (item.href === "/settings" ? pathname === "/settings" : pathname === item.href)) ?? sidebarItems[0];
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-2">
                      ...
                      {active && <span className="text-[10px] font-semibold uppercase tracking-[0.16em] text-primary">Current</span>}
                    </div>
