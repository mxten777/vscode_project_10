-- ============================================================================
-- Migration 024: get_ai_insights_v2 ? 연산자 버그 수정
-- 문제: plpgsql 함수 내 임베디드 SQL에서 JSONB 변수에 ? 연산자 사용 시
--       PostgreSQL이 prepared statement 파라미터 플레이스홀더로 오인 → 오류
-- 해결: ? 연산자를 모두 jsonb_exists() 함수로 교체
-- ============================================================================
